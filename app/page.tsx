...
export default async function Home() {
  ...
  const duties = await kv.hgetall('duties') as DutySchedule;
  ...
  return (
    <main className='container relative flex flex-col gap-8 px-4 pt-8 w-2/4'>
      ...
      <Link 
          href='/new-duty'
          className="fixed text-center bottom-10 left-1/2 -translate-x-1/2 text-neutral-900 bg-[#45EDAD] font-display font-regular text-2xl rounded-md w-2/5">
            Add New Duty
      </Link>
    </main>
  )
